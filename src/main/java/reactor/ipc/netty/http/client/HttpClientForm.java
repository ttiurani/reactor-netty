...
public interface HttpClientForm {
	 ...
	 * @return this builder
	 */
	default HttpClientForm file(String name, File file, String contentType) {
	 ...
	 * @return this builder
	 */
	HttpClientForm file(String name, String filename, File file, String contentType);
	 ...
	 * @return this builder
	 */
	default HttpClientForm file(String name, InputStream stream, String contentType) {
	 ...
	 * @return this builder
	 */
	HttpClientForm file(String name, String filename, InputStream stream, String contentType);
	 ...
	 * @return this builder
	 */
	HttpClientForm textFile(String name, File file, String contentType);
	 ...
	 * @return this builder
	 */
	HttpClientForm textFile(String name, InputStream inputStream, String contentType);
}
