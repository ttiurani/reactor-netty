...
final class HttpClientLifecycle extends HttpClientOperator
	...
	HttpClientLifecycle(HttpClient client,
			Consumer<? super HttpClientRequest> onRequest,
			Consumer<? super HttpClientRequest> afterRequest,
			Consumer<? super HttpClientResponse> onResponse,
			Consumer<? super HttpClientResponse> afterResponse) {
		super(client);
